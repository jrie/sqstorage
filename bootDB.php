...
DB::query('CREATE TABLE IF NOT EXISTS `customFields` (`id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, `label` varchar(64) NOT NULL, `dataType` int(10) UNSIGNED NOT NULL, `default` varchar(64) DEFAULT NULL, `defaultVisible` tinyint(1) NOT NULL DEFAULT 0, `visibleIn` varchar(1024) DEFAULT NULL, `fieldValues` varchar(1280) DEFAULT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB;');
